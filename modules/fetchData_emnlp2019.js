...
const GOOGLE_APP_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzhiH6N938vsgap6CsosVNNMRmJBmqCyVjW0d5LPzioVkhF_kRd/exec'
...
module.exports = function fetchData() {
  ...
  const getData = async builder => {
    ...
    const allSummaries = await axios.get(urls[3]).catch((e) => { console.error(e); throw e; });
